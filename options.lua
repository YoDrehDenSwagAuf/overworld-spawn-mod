...
return {
  ...
  },
  {
    ...
    description = "Overworld Pokemon sprite source. Auto prefers Gold Sprites, then Followers EX, then Crystal, then Wilds PokeMMO-style sheets, then Pokedex images.",
  },
  {
    key = "spawn_density",
    label = "Spawn Amount",
