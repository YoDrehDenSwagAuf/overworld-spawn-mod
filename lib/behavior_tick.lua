...
--
-- Visual work (Movement interpolation, SpawnFx, animation sync) runs every
-- rendered frame. AI decisions / occupancy rebuild / cave rebuild checks run
-- at a fixed AI rate so cost does not scale with 144/240 Hz displays.
local V = ...
