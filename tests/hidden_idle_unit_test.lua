-- Hidden Idle + Grass Enc + Start-menu Spawn Amount unit tests.
...
check(h10 >= 2 and h10 <= 4, "hidden ~20-35% of 10 (got " .. tostring(h10) .. ")")
local b10 = HiddenIdle.targetCount(10, "both")
check(b10 >= 1 and b10 <= 2, "both ~10-20% of 10 (got " .. tostring(b10) .. ")")
...
for _ = 1, 40 do
  local e = HiddenIdle.tick(entity, 0.02)
...
Config.STATE = Config.STATE -- ensure
-- Config.STATE.AVAILABLE is "available"
