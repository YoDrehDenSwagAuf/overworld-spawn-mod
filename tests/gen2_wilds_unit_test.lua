...
eq(GameCompat.supportsFeature("followers", mod, goldGame), false, "followers off")
...
check(not wrappedHook("ui.party.submenu"), "follower party submenu NOT wrapped")

eq(mod.exports.follower._installed, false, "follower hooks stay off")
